...
INCLUDEPATH += $$PWD/lib/portaudio/include
INCLUDEPATH += $$PWD/lib/fftw/include
INCLUDEPATH += $$PWD/src/
INCLUDEPATH += $$PWD/
exists($$PWD/src/test/*.h) {
...
macx{
 ...
 LIBS += -L$$PWD/lib/portaudio -lportaudio
 LIBS += -L$$PWD/lib/fftw -lfftw3
}
DEPENDPATH += $$PWD/lib/portaudio/include
DEPENDPATH += $$PWD/lib/fftw/include

macx {
 PRE_TARGETDEPS += $$PWD/lib/portaudio/libportaudio.a
 PRE_TARGETDEPS += $$PWD/lib/fftw/libfftw3.a
}
